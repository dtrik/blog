...
## Levels of Learning
 Bloom's taxonomy of learning indicates the steps in which learning happens:
1. Remembering.
2. Understanding
3. Analysis
4. Evaluation
...
## Adult Learning 
The book refers to the research of Malcolm Knowles on how adults learn. An important change on learning once we become adults is knowing why we learn. Children usually learn on demand. The whys and hows are not considered that important. But as we become adults, learning happens best through active practice and participation. We have to convince the brain that the knowledge is immediately useful. This can hinder but also can speed up learning.

Knowles suggests the following:
1. Start with a problem and work towards a solution
The usual way is starting from the basics (eg. "Hello World" in programming). We finally reach a point where we use it for a complicated task. Instead, go the other way round. Try to solve an interesting problem in the area of learning and then learn as required. This provides immediate feedback and at the same time keeps things interesting.

2. Customize the path to learning according to your requirements
Some things are necessary, some are not. While learning from a structured plan, try to figure out the most important things and learn them. Learn a few optional things, ignore a few for later. Take different paths, don't stick rigidly to an external plan.

3. Internal motivation is important
External motivation is not effective after a point. Instead, as adults we have to motivate ourselves to learn something. For this, we have to deeply introspect on why we want to learn it - dive deep into the why.

4. Plan ahead to structure the sequence of learning
This is very important. Instead of just pushing ahead without a plan, first structure what and how we are learning. 

### Learning Plan
While planning ahead focus on the following:
1. Why are you learning?
- include why you are learning into your plan
...
6. How is the information accessed - organize access and information?
- the information we learn should be accessible in the most useful order (eg. remembering what an array is before sorting an array)
     
7. What is the study schedule and how can you compress it?
- Parkinson's Principle - work expands to fill the schedule, reverse this. Adding real world stakes might be helpful in compressing the schedule. Tricking your brain (eg. a public lecture on a topic within 2 weeks for a topic that you think might take you 4 weeks)
     
8. How can you measure your progress?
...
9. What happens if things don't go according to plan?
...
## Memory
For learning anything, the memory is crucial. A blind devotion to memorisation is not useful in learning. But we need to be able to recall the required chunks of information. The bigger the chunk that can be recalled, the more we can learn.
...
### Evolution 
Our brains are really good at remembering smells, tastes and sights. These were crucial in determining whether your species survived to the next day or not. Avoiding poisonous food, predators and recognizing the social group were all crucial for survival. These instincts persist. Smells can trigger extremely detailed memories. We also remember locations to an almost absurd level of detail. 
...
Then question yourself on why you are reading that part. This creates curiosity for reading. Use cognitive biases to trick the brain into interest.

The above two are together referred to as pre-reading. This also involves questioning -  Why are we reading, how is it useful. Now build a mental map of the material. Form markers and anchor points, get a general picture of the material and how it is structured.
...
### Speed reading
Once you learn to speed read, you are not going to jump to 5000 words per minute and zoom through War and Peace in an hour. But you can still raise your reading speed. 600-800 words per minute while retaining 80-90% comprehension are possible. But like most skills, it is something that can rust without use. So practice it often. Pick and choose if something has to be speed read. Speed reading a very interesting novel might ruin the thrill. 

The following are the primary ways to improve your reading speed significantly:
1. Reduce subvocalisation - Completely removing subvocalisation is impossible. So attempt to reduce it such that you are subvocalising the most important words in a line. It is still very hard to do. 
2. When we read, our eyes jump around and each jump results in a period of blindness. This is imperceptible and referred to as a saccade. These saccades affect our reading speed. So, to increase your reading speed, reduce the number of times spent in saccadic blindness. This can be done by training to reduce the number of fixations. The Schultz table is used for this.
3. Optimize fixations. Focus on optimally spaced words in a line. Use progressive workload to learn this. Read at speed you are barely comprehending. Then train to read at this speed and when it becomes comprehensible increase speed to next level. This is much like physical training, where as we are able to lift a particular weight, it is increased to the next level. 

## Cross-pollination
Another interesting idea that comes up here is brute-force learning. In brute-force hacking, a hacker gets into a system  by trying out all possible options. We can hack our brains into learning something by learning from all possible options. An insight in biology might help somewhere in computer science.

Learning many things together is also not bad. Learning anything helps in learning everything. Jump around and get ideas from everywhere. If something is difficult to understand, approach it from another angle. Variety is important in learning. 
...
1. Sleep: our brains need rest. While sleeping, the hippocampi strengthens connections and cleans clutter. Without proper sleep, learning is impossible
